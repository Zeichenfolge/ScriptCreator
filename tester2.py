...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.final_pushButton.setGeometry(QtCore.QRect(370, 390, 93, 28))
        self.final_pushButton.setObjectName("final_pushButton")
        self.listWidget = QtWidgets.QListWidget(self.centralwidget)
        self.listWidget.setGeometry(QtCore.QRect(470, 20, 301, 501))
        ...
        self.check_pushButton.setGeometry(QtCore.QRect(150, 300, 93, 28))
        self.check_pushButton.setObjectName("check_pushButton")
        self.variable_comboBox = QtWidgets.QComboBox(self.centralwidget)
        self.variable_comboBox.setGeometry(QtCore.QRect(60, 160, 301, 41))
